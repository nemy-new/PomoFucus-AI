...
interface EditTaskModalProps {
    onClose: () => void;
    onSave: (updates: { title: string, estimatedPomodoros: number, eta: string }) => void;
    task: Task;
    apiKey?: string;
}

const EditTaskModal: React.FC<EditTaskModalProps> = ({ onClose, onSave, task, apiKey }) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-xl font-semibold mb-6 text-on-surface dark:text-on-surface-dark">{t('addTaskModal.editTitle')}</h2>
